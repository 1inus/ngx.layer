...
var NgxLayerRef = (function () {
    function NgxLayerRef() {
    }
    NgxLayerRef.prototype.close = function () {
        this.layer.close();
    };
    ;
    NgxLayerRef.prototype.showCloseBtn = function (show) {
        this.layer.config.closeAble = show;
        return this;
    };
    NgxLayerRef.prototype.setTitle = function (title) {
        this.layer.config.title = title;
        return this;
    };
    NgxLayerRef.prototype.setMessage = function (message) {
        this.layer.config.message = message;
        return this;
    };
    NgxLayerRef.prototype.setOnClose = function (callBack) {
        this.layer.onClose = callBack;
        return this;
    };
    NgxLayerRef.prototype.setOkText = function (ok) {
        this.layer.config.okTxt = ok;
        return this;
    };
    NgxLayerRef.prototype.setCancelText = function (cancel) {
        this.layer.config.cancelTxt = cancel;
        return this;
    };
    NgxLayerRef.prototype.ok = function (okCallback) {
        this.layer.onOk = okCallback;
        return this;
    };
    NgxLayerRef.prototype.cancel = function (cancelCallback) {
        this.layer.onCancel = cancelCallback;
        return this;
    };
    return NgxLayerRef;
}());
exports.NgxLayerRef = NgxLayerRef;
var NgxLayer = (function () {
    function NgxLayer(resolver, app) {
        this.resolver = resolver;
        this.app = app;
        this.container = null;
    }
    NgxLayer.prototype.dialog = function (config) {
        return this.initLayerWraper(config, "dialog");
    };
    NgxLayer.prototype.alert = function (config) {
        return this.initLayerWraper(config, "alert");
    };
    NgxLayer.prototype.confirm = function (config) {
        return this.initLayerWraper(config, "confirm");
    };
    NgxLayer.prototype.tip = function (config) {
        return this.initLayerWraper(config, "tip");
    };
    NgxLayer.prototype.loading = function (config) {
        return this.initLayerWraper(config, "loading");
    };
    NgxLayer.prototype.initLayerWraper = function (config, type) {
        ...
        var confac = this.resolver.resolveComponentFactory(NgxLayerComponent);
    ...
    NgxLayer.prototype.createContainer = function () {
        var confac = this.resolver.resolveComponentFactory(NgxLayerComponent);
    ...
    NgxLayer.prototype.default_ = function (config) {
        var dfs = {
            title: "",
            align: "top",
            closeAble: true,
...
exports.NgxLayer = NgxLayer;
var NgxLayerComponent = (function () {
    function NgxLayerComponent(vcRef, lyRef, resolver) {
        this.resolver = resolver;
        this.config = {};
        this.isDialog = false;
        this.isAlert = false;
    ...
    NgxLayerComponent.prototype.ngOnInit = function () {
    ...
    NgxLayerComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    NgxLayerComponent.prototype.onOk = function () {
        return true;
    };
    NgxLayerComponent.prototype.onClose = function () {
        return true;
    };
    NgxLayerComponent.prototype.onCancel = function () {
        return true;
    };
    NgxLayerComponent.prototype.ok = function () {
        if (!this.onOk || this.onOk())
            this.close();
    };
    NgxLayerComponent.prototype.cancel = function () {
        if (!this.onCancel || this.onCancel())
            this.close();
    };
    NgxLayerComponent.prototype.close = function () {
        var _this = this;
        if (!this.onClose || this.onClose()) {
            if (this.config.outSelector) {
                this.bodyEle.addEventListener("animationend", function (e) {
    ...
    NgxLayerComponent.prototype.calCss_ = function () {
    ...
    ], NgxLayerComponent.prototype, "layerView", void 0);
    __decorate([
        core_1.ViewChild('layerHeader', { read: core_1.ViewContainerRef }),
        __metadata("design:type", core_1.ViewContainerRef)
    ], NgxLayerComponent.prototype, "layerHeader", void 0);
    NgxLayerComponent = __decorate([
        core_1.Component({
        ...
        __metadata("design:paramtypes", [core_1.ViewContainerRef, NgxLayerRef, core_1.ComponentFactoryResolver])
    ], NgxLayerComponent);
    return NgxLayerComponent;
}());
exports.NgxLayerComponent = NgxLayerComponent;
